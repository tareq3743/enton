...
3. **Download the installer:**  
   Click on the installer file with `.exe` extension. It usually includes "windows" or "setup" in the file name.
...
- Allow access to your camera and microphone when prompted. This is needed for enton’s vision and voice functions.  
...
## 🎤 Using enton with Voice Commands
...
- If voice commands don’t work, speak clearly and try a quiet room.  
...
## 📚 Learn More About enton’s Technology
